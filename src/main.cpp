...
int main()
{
    try {
        ...
        std::map<int32_t, line_sep::line::Line> lines;
        line_sep::misc::io::load_lines(filepath, lines);
        ...
        std::map<int32_t, line_sep::line::LR_adj> line_adjs;
        ...
        std::map<int32_t, std::shared_ptr<line_sep::line::GCol>> grid;
        ...
        line_sep::misc::io::safe_lines_with_dist(ofilepath, lines);
